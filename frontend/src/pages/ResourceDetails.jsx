        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6">
            <div className="max-w-3xl mx-auto mt-20">
                ...
                <motion.button
                    ...
                    className="mb-8 cursor-pointer flex items-center gap-2 text-indigo-600 hover:text-indigo-800 font-medium"
                >
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <motion.button
                                ...
                                className="flex-1 cursor-pointer flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-6 rounded-lg font-medium transition-colors"
                            >
                                <FaDownload />
                                Download
                            </motion.button>
                            ...
                            <motion.button
                                ...
                                className="flex-1 cursor-pointer flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 py-3 px-6 rounded-lg font-medium transition-colors"
                            >
                                <FaThumbsUp />
